...
get_prompt() {
    case "$1" in
        ...
        "plan_1") echo "/plan flesh out the plan. conduct further investigations if needed to fill in gaps/reduce ambiguity. do not execute yet, just plan. dont hesitate to use standalone/debugging scripts & add print lines during this task if helpful. update your markdown file(s). use many agents." ;;
        "execute_0") echo "/plan execute the plan (first round). execute the plan step by step. dont hesitate to use standalone/debugging scripts & add print lines during this task if helpful. update your markdown file(s). use many agents." ;;
        ...
        "verify_0") echo "/plan verify that all tasks in the plan are complete, through whatever means and methods required to verify and validate. dont hesitate to use standalone/debugging scripts & add print lines during this task if helpful. update your markdown file(s). use many agents." ;;
        "verify_1") echo "/plan verify that all tasks in the plan are complete, through whatever means and methods required to verify and validate. dont hesitate to use standalone/debugging scripts & add print lines during this task if helpful. update your markdown file(s). use many agents." ;;
        "cleanup") echo "/plan conduct a deep and thorough cleanup of the project. remove all files and directories that are no longer needed. update your markdown file(s). use many agents." ;;
