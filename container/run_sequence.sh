...
get_prompt() {
    case "$1" in
        "investigate") echo "/plan conduct deep and thorough investigations, research, testing, debugging, etc on the task at hand. do not plan/execute yet, just investigate/research. dont hesitate to use standalone/debugging scripts & add print lines during this task if helpful. use many agents." ;;
        ...
        "plan_1") echo "/plan flesh out the plan. conduct further investigations if needed to fill in gaps/reduce ambiguity. do not execute yet, just plan. dont hesitate to use standalone/debugging scripts & add print lines during this task if helpful. use many agents." ;;
        "execute_0") echo "/plan execute the plan (first round). execute the plan step by step. dont hesitate to use standalone/debugging scripts & add print lines during this task if helpful. use many agents." ;;
        "execute_1") echo "/plan execute the plan (second round). if there is nothing left to do (within the plan and scope), then just return (do nothing). if there are remaining items, lets keep going. dont hesitate to use standalone/debugging scripts & add print lines during this task if helpful. use many agents." ;;
        "execute_2") echo "/plan execute the plan (third round). if there is nothing left to do (within the plan and scope), then just return (do nothing). if there are remaining items, lets keep going. dont hesitate to use standalone/debugging scripts & add print lines during this task if helpful. use many agents." ;;
        "execute_3") echo "/plan execute the plan (fourth round). if there is nothing left to do (within the plan and scope), then just return (do nothing). if there are remaining items, lets keep going. dont hesitate to use standalone/debugging scripts & add print lines during this task if helpful. use many agents." ;;
        "execute_4") echo "/plan execute the plan (fifth round). if there is nothing left to do (within the plan and scope), then just return (do nothing). if there are remaining items, lets keep going. dont hesitate to use standalone/debugging scripts & add print lines during this task if helpful. use many agents." ;;
        "verify_0") echo "/plan verify that all tasks in the plan are complete, through whatever means and methods required to verify and validate. dont hesitate to use standalone/debugging scripts & add print lines during this task if helpful. use many agents." ;;
        "verify_1") echo "/plan verify that all tasks in the plan are complete, through whatever means and methods required to verify and validate. dont hesitate to use standalone/debugging scripts & add print lines during this task if helpful. use many agents." ;;
        "cleanup") echo "/plan conduct a deep and thorough cleanup of the project. remove all files and directories that are no longer needed. use many agents." ;;
