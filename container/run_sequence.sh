...
get_prompt() {
    case "$1" in
        ...
        "compact_0") echo "/compact remember everything so far in verbose detail. list the names/locations of all planning/markdown file(s) in this conversation specifically." ;;
        ...
        "compact_1") echo "/compact remember everything so far in verbose detail. list the names/locations of all planning/markdown file(s) in this conversation specifically." ;;
        ...
        "compact_2") echo "/compact remember everything so far in verbose detail. list the names/locations of all planning/markdown file(s) in this conversation specifically." ;;
        ...
        "compact_3") echo "/compact remember everything so far in verbose detail. list the names/locations of all planning/markdown file(s) in this conversation specifically." ;;
